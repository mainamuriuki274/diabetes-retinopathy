...
public class EyeTypeClassifier{
     ...
     * @throws IOException
     */
    public EyeTypeClassifier(Activity activity) throws IOException {
        /*
         * The loaded TensorFlow Lite model.
         */
        MappedByteBuffer classifierModel = FileUtil.loadMappedFile(activity,
                "eye_type_quant_tflite_model.tflite");
        // Loads labels out from the label file.
        labels = FileUtil.loadLabels(activity, "eye_type_labels.txt");
